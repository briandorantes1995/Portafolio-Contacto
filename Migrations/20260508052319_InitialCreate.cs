        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubStatus = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OldSubStatus = table.Column<int>(type: "int", nullable: true),
                    NewSubStatus = table.Column<int>(type: "int", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobFiles_UploaderId",
                table: "JobFiles",
                column: "UploaderId");

            migrationBuilder.CreateIndex(
                name: "IX_JobHistories_ChangerId",
                table: "JobHistories",
                column: "ChangerId");
